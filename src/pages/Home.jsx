...
// import { BackgroundSystem, ParticleSystem, IconAnimations } from '../components/HeroSection';
  ...
  return (
    <>
      ...
      <section className="relative py-10 sm:py-16 lg:py-28 overflow-hidden" style={{background: 'linear-gradient(135deg, var(--bg) 0%, var(--card) 100%)', color: 'var(--primary)'}} data-aos="fade-up">
        <div className="container mx-auto px-2 sm:px-4 flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12 relative min-h-[20rem] sm:min-h-[28rem] lg:min-h-[32rem]">
          {/* Hero Text - Center */}
